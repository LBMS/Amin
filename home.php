...
<center><A href="alumni.html"><input type="submit" value="Learn More" style="background-color:#0FF; border-radius:5px 15px 5px 15px; color:#F00;" /></A></center>
</div>
</div></th>
<!--*******-->
...
<center><a href="involved.php"><input type="submit" value="Learn More" style="background-color:#0CC; border-radius:5px 15px 5px 15px; color:#F00;"/></A></center>
</div>
</div></th>
<th><div class="shadow-sample" >
<div id="box" >
