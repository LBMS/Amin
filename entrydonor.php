...
<div class="wrapper row2">
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="entrydonor.php">Donors</a></li>
...
if(isset($_POST['submit1'])){
	$name1=$_POST['name1'];
	$add1=$_POST['add1'];
 $sql="insert into donor(`name`,`add`) values('$name1','$add1')";
	 mysql_query($sql);
}
...
<caption><B>--DONOR LIST--</B></caption>
<form method="post">
	...
	<tr>
		<th><center>NAME</center></th><th><center>ADDRESS</center></th>
	</tr>
	
    <tr>
		<td><input type="text" name="name1" value=""></td><td><input type="text" name="add1" value=""></td>
		</tr><tr><td colspan="2"><input type="submit" name="submit1" value="submit">
	</td></tr>
