    ...
    <ul>
      ...
      <li><a href="#">Profile</a>
        <ul>
          ...
          <li class="active"><a href="entryaward.php">Awards</a></li>
...
if(isset($_POST['submit1'])){
	$name1=$_POST['name1'];
	$add1=$_POST['add1'];
 $sql="insert into award(`date`,`awrd`) values('$name1','$add1')";
	 mysql_query($sql);
}
...
<form method="post">
	...
	<tr>
		<th><center>Date</center></th><th><center>Awards</center></th>
	</tr>
	
    <tr>
		<td><input type="text" name="name1" value=""></td><td><input type="text" name="add1" value=""></td>
		</tr><tr><input type="submit" name="submit1" value="submit">
	</tr>
