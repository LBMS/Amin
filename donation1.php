...
<img src="images/helen1.PNG" width="95%"></td></tr></table>


</div>
<div id="divright" >
<form name="signup" action="donorlogin.php" method="post">
<table border="0">
<tr>
<th>EMAIL:</th><TD><input type="text" name="mail" /></TD></tr>
<tr>
<th>PASSWORD:</th><TD><input type="password" name="password" /></TD></tr>
<tr>
<td><input type="submit" name="submit" value="LOGIN" /></td><td> <a href="donation2.php">new user ?</a></td>
</tr>
</table></form>
<br /><br /><br /><br /><br /><br />
</div>
